...
assumeRole = Request.request service method  where
    service = Request.ServiceName "STS"
    method = Request.MethodName "assumeRole"
...
assumeRoleWithSAML = Request.request service method  where
    service = Request.ServiceName "STS"
    method = Request.MethodName "assumeRoleWithSAML"
...
assumeRoleWithWebIdentity = Request.request service method  where
    service = Request.ServiceName "STS"
    method = Request.MethodName "assumeRoleWithWebIdentity"
...
decodeAuthorizationMessage = Request.request service method  where
    service = Request.ServiceName "STS"
    method = Request.MethodName "decodeAuthorizationMessage"
...
getCallerIdentity = Request.request service method  where
    service = Request.ServiceName "STS"
    method = Request.MethodName "getCallerIdentity"
...
getFederationToken = Request.request service method  where
    service = Request.ServiceName "STS"
    method = Request.MethodName "getFederationToken"
...
getSessionToken = Request.request service method  where
    service = Request.ServiceName "STS"
    method = Request.MethodName "getSessionToken"
